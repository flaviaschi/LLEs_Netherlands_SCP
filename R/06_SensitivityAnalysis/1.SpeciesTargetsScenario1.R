...
# Sceanrio 1 (Maximize ES Scenario)
#===============================================================================
...
speciestargets <- function(lb, hb) {
  ...
  #Save csv
  write.csv(needed_sp_target, paste0("Outcomes/targets/Scenario1/", "Scen1_Target_LB", lb, "_HB", hb, ".csv"))
  needed_sp_target$needed_sp_target
  
}


### Set two sceanrios in which all species get assigned 10% or 100% target

# 10% target for all species
needed_sp_target10<-rep(c(0.1), times=23)
needed_sp_target10<-as.data.frame(needed_sp_target10)
needed_sp_target10 <- cbind(needed_sp_target10, sp_list)
write.csv(needed_sp_target10, "Outcomes/targets/Scenario1/Scen1_Target_10.csv")

# 100% target for all species
needed_sp_target100<-rep(c(1.0), times=23)
needed_sp_target100<-as.data.frame(needed_sp_target100)
needed_sp_target100 <- cbind(needed_sp_target100, sp_list)
write.csv(needed_sp_target100, "Outcomes/targets/Scenario1/Scen1_Target_100.csv")
